...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="EVAL-ADAS1000SDZ" -proc ADSP-BF527 -si-revision 0.2 -DCORE0 -DNDEBUG @includes-3704bab241cad1b8931e3a2e1052cbe7.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
